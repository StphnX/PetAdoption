    ...
    return (
        ...
        <main className="content">
            <div className="about-page-container">
                <h1>Welcome to ClearTheShelters!</h1>
                <p>
